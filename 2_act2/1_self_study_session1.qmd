...
Start with the notebook from @{sec-act1-selfstudy1}, recreate the visualizations from @{sec-act2} using `plotly`, and explore the data interactively.
:::
...
5. Allow for choosing the failure type interactively using a Dropdown widget (see [Jupyter widgets](https://ipywidgets.readthedocs.io/en/stable/)) with the available failure types.
